...
function buildNotes(o, taskNumber, sc) {
  ...
  if (low[0] === "task" && taskNumber === 1) {
    ...
    if (a(o.featuresMissing).length) weaknesses.push(`Дурдагдаагүй үлдсэн: ${a(o.featuresMissing).slice(0, 3).join(", ")}.`);
    if (o.speculation === true) weaknesses.push("Зураг дээр байхгүй шалтгааныг таамагласан. Task 1-д зөвхөн харагдаж буйг тайлбарлана.");
  } else if (low[0] === "task") {
  ...
  // Дор хаяж хоёр зүйл байлгана
  if (!weaknesses.length)
    weaknesses.push(`Ноцтой дутагдал алга. ${lowName} хэсэг харьцангуй бага (${low[1].toFixed(1)}) тул дараагийн band руу гарахад энэ чиглэлд анхаар.`);
  if (weaknesses.length < 2)
    weaknesses.push("Санаа бүрийг нэг өгүүлбэрээр орхихгүй, тайлбар эсвэл үр дагавраар нь өргөжүүлж бич.");
